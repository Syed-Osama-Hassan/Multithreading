...
public class Main {
	public static final String SOURCE_FILE = "./image_processing/many-flowers.jpg";
	public static final String DESTINATION_FOLDER = "./image_processing/many-flowers-result.jpg";
	...
	public static void main(String[] args) throws IOException {
		...
		File outputFile = new File(DESTINATION_FOLDER);
	...
	public static void recolorImage(BufferedImage originalImage, BufferedImage resultImage,
		...
		for(int x = leftCorner; x < leftCorner + width && x < originalImage.getWidth();
				x++) {
			for(int y = topCorner; y < topCorner + height && y < originalImage.getHeight();
					y++) {
